        ...
        <div className='grid grid-cols-1 items-center gap-12 lg:grid-cols-2'>
          ...
          <div>
            ...
            <div className='mt-2 rounded-2xl bg-blue-500 p-6'>
              <h1 className='mb-6 mt-6 text-2xl font-bold text-white sm:text-4xl md:text-5xl md:leading-[3rem] lg:leading-[3.5rem]'>
            ...
            <ul className='mb-[80px] mt-8 max-w-xl list-disc space-y-4 pl-4 font-bold text-muted-foreground'>
